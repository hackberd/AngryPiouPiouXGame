class APP_Block_Wood_2000 extends APP_Block;
...
auto state Fixed{
	...
	event RigidBodyCollision( PrimitiveComponent HitComponent,
			...
			}else if ( Health < (ImpactForceForDestruction / 2)) {
...
DefaultProperties
{
    ...
    ImpactForceForDestruction=5000.0
	...
	Begin Object Name=StaticMeshComponent0
		    ...
		    Materials(0)=Material'AngryPiouPiouXAllAssets.Materials.M_Wood'
