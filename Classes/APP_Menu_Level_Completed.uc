...
class APP_Menu_Level_Completed  extends MobileMenuScene;
...
{		
   ...
   if(Sender.Tag ~= "QuitButton"){ 
    ...
    //  RequestClosing();
	  ...
	  APP_GAME(InputOwner.Outer.worldinfo.Game).getGameStateController().LoadNextLevel();
	 RequestClosing();
   } 
}
